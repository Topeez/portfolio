            ...
            <div className="flex md:flex-row flex-col justify-between items-center gap-10 cs-container">
                ...
                <div className="flex flex-col items-center md:items-start gap-6 md:gap-10">
                    <div className="flex sm:flex-row flex-col items-center gap-4 sm:text-left text-center">
                        ...
                        <div>
                            <div className="font-bold text-xl md:text-2xl">{t("name")}</div>
                            <div className="text-muted-foreground text-base md:text-xl">{t("job")}</div>
                        </div>
                    </div>
                    ...
                    <ul className="flex items-center gap-4 list-none">
                        <li className="footer-socials">
                            <Link href="https://www.linkedin.com/in/ond%C5%99ej-top%C3%ADnka-195bb4275/" className="will-change-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 50 50" className="fill-foreground size-6 md:size-8 will-change-transform">
                        ...
                        <li className="footer-socials">
                            <Link href={"https://github.com/Topeeez"}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 30 30" className="fill-foreground size-6 md:size-8">
                ...
                <div className="flex flex-col items-center gap-6 md:gap-10 w-full md:w-auto">
                    <div>
                        <Button className="hover:bg-gradient-to-r from-blue-600 to-sky-400 p-6 rounded-2xl hover:text-white text-xl transition-all ease-in-out cursor-pointer">
                            {t("ctabutton")}
                        </Button>
                    </div>
                    ...
                    <div className="flex md:flex-row flex-col justify-center gap-8 w-full text-center">
                        <div>
                            <div className="font-bold text-lg md:text-xl">Email</div>
                            <div className="text-muted-foreground text-base">topetopinka7@seznam.cz</div>
                        </div>
                        <div>
                            <div className="font-bold text-lg md:text-xl">Discord</div>
                            <div className="text-muted-foreground text-base">t0p33z</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-8 cs-container">
                ...
                <div className="flex md:flex-row flex-col justify-between items-center gap-4 text-center">
                    <div className="text-sm md:text-base">
                        {t('copyright1')}{new Date().getFullYear()}{t("copyright2")}
                    </div>
                    <Links />
                </div>
            </div>
