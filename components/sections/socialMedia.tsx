...
export const socialMedia: SocialItem[] = [
    {
        icon: LinkedinIcon,
        link: "https://www.linkedin.com/in/ond%C5%99ej-top%C3%ADnka-195bb4275/",
        label: "LinkedIn",
    },
    {
        icon: GithubIcon,
        link: "https://github.com/Topeez/",
        label: "Github",
    },
    {
        icon: InstagramIcon,
        link: "https://www.instagram.com/_.to.pe._?igsh=MWo3Z2N0Z2tmbXd2aQ==",
        label: "Instagram",
    },
    {
        icon: DiscordIcon,
        link: "https://discord.com/users/t0p33z",
        label: "Discord",
    },
];
